...
public class VistaJineteAliado extends VistaEntidad{
	
	private final static String JINETE_ALIADO = "src/main/Imagenes/jinete.png";

	public VistaJineteAliado(Entidad entidad, VistaDelTablero vistaDelTablero) {
		super(entidad, vistaDelTablero, new Sprite(JINETE_ALIADO));
	}
