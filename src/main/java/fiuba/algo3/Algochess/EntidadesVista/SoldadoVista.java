...
public class SoldadoVista{
	...
	public SoldadoVista(VistaDelTablero tablero,Entidad entidad) {
	...
	private Image getImage() {
		try {
			BufferedImage bff = ImageIO.read(new File("src/main/Sprites/soldado.png"));
